...
use super::components::PlayerScore;
...
impl Plugin for UiPlugin {
    fn build(&self, app: &mut App) {
        app.add_system_set(SystemSet::on_enter(AppState::InGame).with_system(setup_scoreboard))
...
fn on_score_event(
    ...
    mut text_query: Query<&mut Text, With<PlayerScore>>
){
